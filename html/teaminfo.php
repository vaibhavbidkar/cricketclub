...
<head>
    ...
    <script src="/js/jqueryAnimation.js" defer></script>
...
<body>
  <nav class="navMenu">
    <img src="/images/logo.png" class="navbar-brand" style="height: 100px;" alt="" srcset="">
      ...
      <br>
      <img src="/images/teamlogo.png" alt="bcci_logo" style="height: 140px;" alt="" srcset="" class ="teamlogo">
      <p>The India men's national cricket team, also known as Team India or the Men in Blue, represents India in men's international cricket. It is governed by the Board of Control for Cricket in India (BCCI), and is a Full Member of the International Cricket Council (ICC) with Test,
         ...
         <div class="jqanimate" style="position: relative;">

          <img src="../images/dhoni.png" style="position: relative;" width="350px" id="dhoni"  alt="">
          <img src="../images/ball.png" style="position: absolute; left: 120px; bottom: 56px;" class="ball" width="20px" alt="">
        <!-- <button class="animation">animate</button>  -->
        </div>

         <h3>ICC Achivements</h3>
         
         <br>

        <figure >
          <div class="cups">
            <img src="/images/t20wc.png" />
            <figcaption class="caption">T20 WC: 2007</figcaption>
          </div>
          <div class="cups">
            <img src="/images/odiwc.png" />
